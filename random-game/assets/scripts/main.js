...
console.log("!!!Выполните debugModeFlg= true в консоли, чтобы его включить");
 ...
 console.log("\n",
 "Игра для тренировки устного счета дошкольников. Нужно собрать 4 в ряд. Вбыирать можно только те ячейки, сумма которых равно выпала на кубиках.\n",
 "Самооценка 65:\n",
 ...
 "[x] Анимации или звуки, или настройки игры. Баллы начисляются за любой из перечисленных пунктов Анимация +10\n"); 
