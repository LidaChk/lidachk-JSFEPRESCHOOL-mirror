 ...
 function langSwitcher(to) {
  aOpacityItems.forEach(a => document.querySelectorAll(a).forEach(el => el.style.opacity = 0));
   ...
   aOpacityItems.forEach(a => document.querySelectorAll(a).forEach(el => el.style.opacity = 1));
 ...
 window.onload = function () {
   ...
   function OpenNavBar() {
     ...
     let arrTabletItems = ['.navburger__wrapper', '.header__container', '.burger_container', 'h2',
       '.wrapper', '.video_player', 'form__contacts', '.hero__content_box', '.form__contacts', 
       '.skills', '.navigation__link', '.btn_basic', '.container']
